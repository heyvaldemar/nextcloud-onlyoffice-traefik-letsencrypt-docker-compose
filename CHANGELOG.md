...
- **`rabbitmq:4.3-management` was rebuilt upstream**; the pin moved from `sha256:612ebf172397…` to `sha256:a7faa436fbb8…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **Nextcloud 35.** A major upstream release, and a one-way one.
  ...
  **First boot of the new image runs `occ upgrade` on the database, and there
  ...
  The ONLYOFFICE connector app's compatibility with Nextcloud 35 was not
  covered by any note the review could read, and the deploy job does not open
  a document. Check document editing once after the upgrade.
...
- **`nextcloud:34.0.3` moved to `nextcloud:34.0.4`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`rabbitmq:4.3-management` was rebuilt upstream**; the pin moved from `sha256:ffd1b50c522a…` to `sha256:57bddb6fbc34…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
h is exactly the kind of repush this job exists to catch. Both
...
[Unreleased]: https://github.com/heyvaldemar/nextcloud-onlyoffice-traefik-letsencrypt-docker-compose/compare/v2.0.1...HEAD
...
[1.7.4]: https://github.com/heyvaldemar/nextcloud-onlyoffice-traefik-letsencrypt-docker-compose/compare/v1.7.3...v1.7.4
[1.7.3]: https://github.com/heyvaldemar/nextcloud-onlyoffice-traefik-letsencrypt-docker-compose/compare/v1.7.2...v1.7.3
[1.7.1]: https://github.com/heyvaldemar/nextcloud-onlyoffice-traefik-letsencrypt-docker-compose/compare/v1.7.0...v1.7.1
[1.7.0]: https://github.com/heyvaldemar/nextcloud-onlyoffice-traefik-letsencrypt-docker-compose/compare/v1.6.1...v1.7.0
